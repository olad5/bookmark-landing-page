    ...
    return (
        ...
        <div className='container flex flex-col items-center mx-auto mb-12'>
            ...
            <div className='  border-t-[.5px] border-b-[.5px] items-center flex flex-col  w-4/5 border-slate-200 mx-6 mt-4 mb-12 lg:w-fit lg:border-t-0 lg:px-0 lg:flex-row lg:justify-center'>
                <a href="" className="inline-block py-3 lg:text-lg w-fit text-black border-b-4 border-primary-softRed lg:px-10 focus:border-b-4 focus:border-primary-softRed hover:text-primary-softRed">Simple Bookmarking</a>
                    <hr className=' w-full border-t-1 border-slate-200 mx-6 lg:hidden' />
                <a href="" className="inline-block py-3 lg:text-lg w-fit text-black focus:border-b-4 focus:border-primary-softRed lg:px-10 hover:text-primary-softRed">Speedy Searching</a>
                    <hr className=' w-full border-t-1 border-slate-200 mx-6 lg:hidden' />
                <a href="" className="inline-block py-3 lg:text-lg w-fit text-black focus:border-b-4 focus:border-primary-softRed lg:px-10 hover:text-primary-softRed">Easy Sharing</a>
            </div>                                                                                                         
